...
class Response extends Message implements ResponseInterface
{
    ...
    {
        $new = clone $this;
        if (!is_numeric($code) || is_float($code) || $code < static::MIN_STATUS || $code > static::MAX_STATUS) {
            throw new \InvalidArgumentException(sprintf('Invalid status code: "%s"', $code));
        }
        if (!is_string($reasonPhrase)) {
            throw new \InvalidArgumentException(sprintf('Unsupported response reason phrase: "%s"', $reasonPhrase));
        }
